    ...
    <section className="max-w-[1320px] mx-auto px-3 my-[96px]">
      <div className="lg:flex gap-6">
        ...
        <div className="lg:w-[424px] w-full ">
          ...
          <h1 className="text-[#28264D] text-[40px] font-bold leading-[56px]">
            High-impact services to take your business the next level
          </h1>

          <p className="text-[#444] text-[24px] font-normal leading-8 mt-6">
            Good customer service means consistently meeting customers'
            expectations.{" "}
          </p>

          <button
            className={` ${buttonhover.bbtl} bg-secondaryColor w-[211px] h-[56px] text-white text-[18px] font-bold mt-12 leading-6 tracking-[0.09px]`}
          >
            Explore Services
          </button>
        </div>
